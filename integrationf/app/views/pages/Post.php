...
require_once '../../models/Comment.php'; // Include the Post model file
        ...
        <div class="col-md-6">
          ...
          <form method="POST" action="process_post.php" enctype="multipart/form-data"
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="title" name="title" value="" oninput="validateTitle()">
              <div id="titleError" class="error"></div>

            </div>
            <div class="mb-3">
              <label for="contentP" class="form-label">Content</label>
              <textarea class="form-control" id="contentP" name="contentP" oninput="validateContent()"></textarea>
              <div id="contentError" class="error"></div>

            </div>
            <div class="mb-3">
              <label for="author" class="form-label">Author</label>
              <input type="text" class="form-control" id="author" name="author" value="" oninput="validateAuthor()">
              <div id="authorError" class="error"></div>
            </div>
            <div class="mb-3">
              <label for="date_created" class="form-label">Date Created</label>
              <input type="date" class="form-control" id="date_created" name="date_created" value=""
                oninput="validateDateCreated()">
              <div id="dateError" class="error"></div>
            </div>
            <div class="mb-3">
              <label for="img" class="form-label">Image</label>
              <input type="file" class="form-control" id="img" name="img">
              <div id="imgError" class="text-danger"></div> <!-- Error message for Image -->
            </div>
    ...
    <script>
      ...
      function validateTitle() {
        ...
        if (!title.match(lettersRegex)) {
          titleError.innerText = "Title should contain only letters";
        } else {
          titleError.innerText = ""; // Clear error message if valid
        }
      }
      ...
      function validateContent() {
        ...
        if (!content.match(lettersRegex)) {
          contentError.innerText = "Content should contain only letters";
        } else {
          contentError.innerText = ""; // Clear error message if valid
        }
      }
      ...
      function validateAuthor() {
        ...
        if (!author.match(alphanumericRegex)) {
          authorError.innerText = "Author should contain only letters and numbers";
        } else {
          authorError.innerText = ""; // Clear error message if valid
        }
      }

      // Function to validate date created
      function validateDateCreated() {
        var dateCreated = document.getElementById("date_created").value;
        var dateError = document.getElementById("dateError");

        if (dateCreated.trim() === "") {
          dateError.innerText = "Date Created is required";
        } else {
          dateError.innerText = ""; // Clear error message if valid
        }
      }
    </script>
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Comment Ref
                      </th>
                  ...
                  <tbody>
                    <?php foreach ($listComments as $comment): ?>
                      <tr>
                        ...
                        <td class="align-middle text-center text-sm">
                          <span
                            class="text-secondary text-xs font-weight-bold"><?php echo $comment['post_title']; ?></span>
                        </td>
                        <td class="align-middle text-center text-sm">
                          <span class="text-secondary text-xs font-weight-bold"><?php echo $comment['USER_NAME']; ?></span>
                        </td>
                        <td class="align-middle text-center text-sm">
                        ...
                        <td class="align-middle">
                          ...
                          <a href="process_comment.php?delete=<?php echo $comment['id_comment']; ?>"
                            class="btn btn-sm btn-danger" data-toggle="tooltip" data-original-title="Delete"
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <form method="POST" action="process_comment.php" enctype="multipart/form-data">
            ...
            <input type="hidden" class="form-control" name="author" value="<?php echo $_SESSION["user_id"]; ?>">
            <div class="mb-3">
