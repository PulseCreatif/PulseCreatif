...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        ...
        <table border="1" align="center">
            ...
            ?>
                <tr>
                    <td><?php echo $certif['Id_Cert']; ?></td>
                    <td><?php echo $certif['Titre_Cert']; ?></td>
                    <td><?php echo $certif['Date_Cert']; ?></td>
                    <td><?php echo $certif['Duree_Cert']; ?></td>

                    <td><?php echo $certif['id_etud']; ?></td>
                    ...
                    <td>
                        <form method="POST" action="modifiercertif.php">
                            ...
                            <input type="image" src="../img/modif.png" class="image-bt" alt="Modifier">
                        </form>
                    </td>
                    <td>
                        <a href="supprimercertif.php?Id_Cert=<?= $certif['Id_Cert']; ?>" onclick="return confirm('Are you sure you want to delete this certificate?');">
                            <img src="../img/supp.png" class="image-bt" alt="Supprimer">
                        </a>
                    </td>
