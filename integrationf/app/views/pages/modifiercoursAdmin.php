                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form action="#" method="POST">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn bg-gradient-primary btn-sm">MODIFY</button>
                            </div>
                            <div class="form-group">
                                <button class="btn bg-gradient-primary btn-sm"><a href="dashboardcours.php">Retour à la liste des cours</a></button>
                            </div>
