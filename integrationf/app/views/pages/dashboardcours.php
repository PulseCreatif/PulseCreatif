...
include __DIR__ . '/../../models/cours.php';
session_start();
        ...
        <table border="1" align="center" width="80%">
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <form method="POST" action="modifiercoursAdmin.php">
                    ...
                    <td>
                        <a href="supprimercoursAdmin.php?Id_cours=<?php echo $cours['Id_cours']; ?>" onclick="return confirm('Are you sure you want to delete this course?');">
