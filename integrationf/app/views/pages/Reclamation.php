...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="dashboardUser.php">
        <img src="../assets/img/logo-ct-dark.png" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">SkillPulse</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="dashboardCertif.php">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Certificat</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="dashboardcours.php">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="dashboardDevoir.php">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <span class="nav-link-text ms-1">Devoir</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="dashboardEvaluation.php">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="Post.php">
            ...
            <span class="nav-link-text ms-1">Post / Commentaires</span>
          </a>
        </li>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              ...
              <div>
                <div>
                  <a href="trieemail.php" class="btn btn-primary" style="text-decoration: none; color: white;">Trier par
                    email</a>
                  ...
                  <tbody>
                    <?php foreach ($listeReclamations as $reclamation): ?>
                      <tr>
                        ...
                        <td class="align-middle text-center text-sm">
                          <span
                            class="text-secondary text-xs font-weight-bold"><?php echo $reclamation['Subject']; ?></span>
                        </td>

                        <td class="align-middle text-center text-sm">
                          <span
                            class="text-secondary text-xs font-weight-bold"><?php echo $reclamation['Description']; ?></span>
                        </td>
                        <td class="align-middle text-center text-sm">
                          <span
                            class="text-secondary text-xs font-weight-bold"><?php echo $reclamation['Email']; ?></span>
                        </td>


                        <td class="align-middle">
                          <a href="?idR=<?php echo $reclamation['idR']; ?>" class="btn btn-sm btn-secondary me-2"
                            data-toggle="tooltip" data-original-title="Edit">Edit</a>
                          <a href="process_reclamation.php?delete=<?php echo $reclamation['idR']; ?>"
                            class="btn btn-sm btn-danger" data-toggle="tooltip"
                            onclick="return confirm('Are you sure you want to delete this reclamation ?');"
                            data-original-title="Delete reclamation">Delete</a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
    ...
    <div class="container-fluid py-4">
      <div class="row">
        <div class="col-md-6">
          <form method="POST" action="process_reclamation.php" enctype="multipart/form-data"
            ...
            <div class="mb-3">
              ...
              <span id="etatError" class="error"></span>
            </div>
            <div class="mb-3">
    ...
    <?php
    // Vérification de la présence et de la validité de l'identifiant de réclamation
    if (isset($_GET['idR']) && is_numeric($_GET['idR'])) {
      $reclamationId = $_GET['idR'];

      // Récupération des détails de la réclamation depuis la base de données
      ...
      if ($reclamationToEdit) {
        ?>
        <!-- Formulaire HTML pour modifier la réclamation -->
        <form method="POST" action="process_reclamation.php" >
          <!-- Champ d'entrée caché pour stocker l'identifiant de la réclamation -->
          <input type="hidden" name="idR" value="<?php echo htmlspecialchars($reclamationToEdit['idR']); ?>">
          <!-- Champs d'entrée pour modifier les détails de la réclamation -->
          <div class="mb-3">
            <label for="type" class="form-label">Type</label>
            <input type="text" class="form-control" id="type" name="type"
              value="<?php echo htmlspecialchars($reclamationToEdit['Type']); ?>">
          </div>
          <div class="mb-3">
            <label for="etat" class="form-label">Etat</label>
            <input type="text" class="form-control" id="etat" name="etat"
              value="<?php echo htmlspecialchars($reclamationToEdit['Etat']); ?>">
          </div>
          <div class="mb-3">
            <label for="description" class="form-label">Description</label>
            <input type="text" class="form-control" id="description" name="description"
              value="<?php echo htmlspecialchars($reclamationToEdit['Description']); ?>">
          </div>
          <div class="mb-3">
            <label for="email" class="form-label">Email</label>
            <input type="email" class="form-control" id="email" name="email"
              value="<?php echo htmlspecialchars($reclamationToEdit['Email']); ?>">
          </div>
          <button type="submit" class="btn btn-success" name="edit">Mettre à jour la réclamation</button>
        </form>
        <?php
      } else {
        // Réclamation non trouvée, affichage d'un message d'erreur
        echo "Erreur : Réclamation introuvable.";
      }
    } else {
      // Aucun identifiant de réclamation fourni dans l'URL, affichage d'un message d'erreur
      echo "Erreur : Identifiant de réclamation non fourni ou invalide.";
    }
    ?>
    </div>
    </div>
    ...
    <script>
      function validateReclamationForm() {
        ...
        // You can define specific regex patterns for each input field if necessary
        ...
        if (etat.trim() === '') {
          document.getElementById('etatError').innerHTML = 'Etat is required.';
          isValid = false;
        }
...
<div id="reclamationsChartContainer">
    <canvas id="reclamationsChart"></canvas>
</div>

<!-- Include Chart.js directly from a CDN -->
...
<script>
                  ...
                  <tbody>
                    ...
                    <?php foreach ($listeCategories as $category): ?>
                      <tr>
                        ...
                        <td class="align-middle text-center text-sm">
                          <span
                            class="text-secondary text-xs font-weight-bold"><?php echo $category['Nom_Categorie']; ?></span>
                        </td>
                        <td class="align-middle text-center text-sm">
                          <span
                            class="text-secondary text-xs font-weight-bold"><?php echo $category['Description_Categorie']; ?></span>
                        </td>
                        <td class="align-middle">
                          <a href="?ID_Categorie=<?php echo $category['ID_Categorie']; ?>"
                            class="btn btn-sm btn-secondary me-2" data-toggle="tooltip"
                            data-original-title="Edit">Edit</a>
                          <a href="process_categorie.php?delete=<?php echo $categoryId; ?>"
        ...
        <div class="col-md-6">
          ...
          <form method="POST" action="process_categorie.php" onsubmit="return validateCategoryForm()">
            <div class="mb-3">
              ...
              <span id="nomCategorieError" class="error"></span>
            </div>
            <div class="mb-3">
              ...
              <span id="descriptionCategorieError" class="error"></span>
            </div>
    ...
    <?php
    // Vérification de la présence de l'identifiant de catégorie dans l'URL
    if (isset($_GET['ID_Categorie']) && is_numeric($_GET['ID_Categorie'])) {
      $categorieId = $_GET['ID_Categorie'];

      // Récupération des détails de la catégorie depuis la base de données
      $categorie = $categorieC->getCategoryById($categorieId);

      // Vérification de l'existence de la catégorie
      if ($categorie) {
        ?>
        <!-- Formulaire HTML pour modifier la catégorie -->
        <form method="POST" action="process_categorie.php">
          <!-- Champ d'entrée caché pour stocker l'identifiant de la catégorie -->
          <input type="hidden" name="ID_Categorie" value="<?php echo htmlspecialchars($categorie['ID_Categorie']); ?>">
          <!-- Champs d'entrée pour modifier les détails de la catégorie -->
          <div class="mb-3">
          ...
          <div class="mb-3">
            <label for="Description_Categorie" class="form-label">Description Catégorie</label>
            <input type="text" class="form-control" id="Description_Categorie" name="Description_Categorie"
              value="<?php echo htmlspecialchars($categorie['Description_Categorie']); ?>">
          </div>
          <button type="submit" class="btn btn-primary" name="edit_category">Enregistrer les modifications</button>
        </form>
        <?php
      } else {
        // Catégorie non trouvée, affichage d'un message d'erreur
        echo "Erreur : Catégorie introuvable.";
      }
    } else {
      // Aucun identifiant de catégorie fourni dans l'URL ou identifiant invalide, affichage d'un message d'erreur
      echo "Erreur : Identifiant de catégorie non fourni ou invalide.";
    }
    ?>
    </div>
    ...
    function validateCategoryForm() {
        ...
        if (nomCategorie.trim() === '') {
            document.getElementById('nomCategorieError').innerHTML = 'Nom Categorie is required.';
            isValid = false;
        }

        if (descriptionCategorie.trim() === '') {
            document.getElementById('descriptionCategorieError').innerHTML = 'Description Categorie is required.';
            isValid = false;
        }
    ...
    <script>
      document.getElementById('sortByNameBtn').addEventListener('click', function () {
        // Envoyer une requête Ajax pour récupérer les catégories triées par nom
        var xhr = new XMLHttpRequest();
        xhr.open('GET', 'sort_categories.php?sort=name', true);
        xhr.onload = function () {
          if (xhr.status >= 200 && xhr.status < 400) {
            // Mettre à jour l'affichage des catégories avec les données triées
            document.getElementById('categoriesList').innerHTML = xhr.responseText;
          } else {
