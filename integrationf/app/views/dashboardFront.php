...
<body>
    ...
    <form id="signupForm">
        <h4>Espace Cours</h4>
        <a href="espProf.php">Afficher vos cours</a>
        <hr>
        <a href="ajoutercours.php">Ajouter un cours</a>
    </form>

    <form id="signupForm">
        <h4>Espace Réclamations</h4>
        <a href="Reclamation.php">Ajouter une réclamation</a>
    </form>

    <form id="signupForm">
        <h4>Espace Post</h4>
        <a href="Post.php">Gérer vos publications</a>
    </form>
