	...
	<div id="courses" class="section">
		<div class="container">
			<div class="row">
				...
				<!-- /Sidebar -->
				<span class="nav-item">
					<center> <a class="btn btn-secondary" href="ajoutercours.php">Ajouter</a></center>
				</span>
				</br>
				<!-- Courses Content -->
				<div class="col-md-9">
							...
							?>
								<div class="col-md-3 col-sm-6 col-xs-6">
									<div class="course">
										...
										<a href="supprimercours.php?Id_cours=<?= $cours['Id_cours']; ?>" onclick="return confirm('Are you sure you want to delete this course?');">
					...
					<div class="row">
						<div class="center-btn">
							<a class="main-button icon-button" href="espProf.php">Plus de cours</a>
						</div>
					</div>
				</div>
			</div>
