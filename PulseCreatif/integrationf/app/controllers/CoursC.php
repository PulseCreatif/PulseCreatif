...
class CoursC
{
    ...
    function recuperercours($Id_cours)
    {
        ...
        $sql = "SELECT * FROM myapp.cours where Id_cours=$Id_cours";
    ...
    public function listcoursF()
    {
        $tab = array();
        $db = config::getConnexion();

        $sql = "SELECT * FROM myapp.cours WHERE Type_cours = 0";
    ...
    {
        $db = config::getConnexion();
        $sql = "DELETE FROM myapp.cours WHERE Id_cours = :Id_cours";
    ...
    {
        $sql = 'INSERT INTO myapp.cours (Nom_cours, Nbr_heures, Type_cours, Nom_Ens) VALUES (:Nom_cours, :Nbr_heures, :Type_cours, :Nom_Ens)';
        $db = config::getConnexion();
        try {
    ...
    public function searchC($search_query)
    {
        ...
        $query = "SELECT * FROM myapp.cours WHERE Nom_cours LIKE :search_query OR Nom_Ens LIKE :search_query OR Type_cours = :type_cours";
    ...
    public function searchCours($filter_options, $course_names)
    {
        ...
        $query = "SELECT * FROM myapp.cours WHERE 1";
    ...
    {
        $sql = "SELECT DISTINCT Nom_cours FROM myapp.cours";
        $db = config::getConnexion();
        try {
            $query = $db->prepare($sql);
            $query->execute();
    ...
    public function getCoursesNamesF()
    {
        $sql = "SELECT DISTINCT Nom_cours FROM myapp.cours WHERE Type_cours = 0";
        $db = config::getConnexion();
        try {
            $query = $db->prepare($sql);
            $query->execute();
