...
if (isset($_GET['Id_Cert'])) {
    ...
    if ($data) {
        ...
        if ($_GET['ACTION'] == 'DOWNLOAD') {
            ...
            $to = "Eya.Latiri@esprit.tn";  // Recipient email address
            $subject = "Certificate PDF";  // Email subject
            //$body = "Please find attached the certificate PDF.";  // Email body
            $body = '<!DOCTYPE html>
            <html lang="en">
            <head>
                <meta charset="UTF-8">
            ...
            <body>
                <div class="container">
                    ...
                    <p>Contact us:<br>Phone: +216 99040330<br>Instagram: PulseCreatif<br>Address: Ghazela, Tunisia</p>
                </div>
            </body>
            </html>
            ...
            try {
                ...
                if ($mail->send()) {
                    ...
                    echo "<script>window.location.href = 'certificatb.php';</script>";
