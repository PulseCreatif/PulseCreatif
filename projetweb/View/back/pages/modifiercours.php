<?php
include_once 'C:/xampp/htdocs/projetweb/Controller/CoursC.php';
include_once 'C:/xampp/htdocs/projetweb/Model/cours.php';
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form action="modifiercours.php" method="POST">
                            ...
                            <div class="form-group">
                                <button class="btn bg-gradient-primary btn-sm"><a href="coursesb.php">Retour à la liste des cours</a></button>
                            </div>
