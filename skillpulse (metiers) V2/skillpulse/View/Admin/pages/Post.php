                ...
                <?php foreach ($listPosts as $post): ?>
                  <tr>
                    ...
                    <td class="align-middle">
                      <a href="edit_post.php?id_post=<?php echo $post['id_post']; ?>" class="btn btn-sm btn-secondary me-2" data-toggle="tooltip" data-original-title="Edit">Edit</a>
                      <a href="process_post.php?delete=<?php echo $post['id_post']; ?>" class="btn btn-sm btn-danger" data-toggle="tooltip" data-original-title="Delete" onclick="return confirm('Are you sure you want to delete this post?');">Delete</a>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
                  ...
                  <tbody>
                    <?php foreach ($listComments as $comment): ?>
                      <tr>
                        ...
                        <a href="process_comment.php?delete=<?php echo $comment['id_comment']; ?>" class="btn btn-sm btn-danger" data-toggle="tooltip" data-original-title="Delete" onclick="return confirm('Are you sure you want to delete this comment?');">
  Delete
</a>
